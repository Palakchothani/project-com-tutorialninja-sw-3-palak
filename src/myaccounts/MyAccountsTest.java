...
public class MyAccountsTest extends Utility
{
    ...
    public void verifyThatUserRegisterAccountSuccessfully() throws InterruptedException{
        ...
        sendTextToElement(By.name("firstname"),"Peter");
        Thread.sleep(500);
        //  3.4 Enter last name
        sendTextToElement(By.name("lastname"),"White");
        Thread.sleep(500);
        //  3.5 Enter email
        sendTextToElement(By.id("input-email"),"peterwhite@gmail.com");
        Thread.sleep(500);
        //  3.6 Enter telephone
        sendTextToElement(By.name("telephone"),"01753448779");
        Thread.sleep(500);
        //  3.7 Enter password
