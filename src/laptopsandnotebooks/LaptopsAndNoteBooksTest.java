...
public class LaptopsAndNoteBooksTest extends Utility {
    ...
    public void verifyProductAddedToShoppingCartSuccessFully() throws InterruptedException {
        ...
        sendTextToElement(By.name("firstname"), "Shubhendra");
        Thread.sleep(500);
        sendTextToElement(By.name("lastname"), "Bhai");
        Thread.sleep(500);
        sendTextToElement(By.id("input-payment-email"),"shubhendrabhai@gmail.com");
        Thread.sleep(500);
        sendTextToElement(By.name("telephone"),"01753844987");
        Thread.sleep(500);
